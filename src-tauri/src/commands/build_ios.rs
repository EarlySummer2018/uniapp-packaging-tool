...
fn resolve_ios_build_environment() -> Result<IosBuildEnvironment, String> {
    let xcodebuild_bin = crate::commands::env::resolve_configured_tool_bin("xcode", "xcodebuild")?;
    let developer_dir = xcodebuild_bin
        ...
        .or_else(|| {
            let configured = crate::commands::env::require_configured_tool_path("xcode").ok()?;
