...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ios::build::prepare_ios_build,
            ios::build::run_ios_build,
            ios::build::generate_ios_project,
            ios::build::build_ios_ipa,
            harmony::build::prepare_harmony_build,
            harmony::build::run_harmony_build,
            ...
            ios::certificate::list_ios_certificates,
            ios::certificate::list_ios_provisioning_profiles,
